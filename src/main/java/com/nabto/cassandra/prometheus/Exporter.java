...
// Adapted from jmx_prometheus_javaagent/src/main/java/io/prometheus/jmx/JavaAgent.java
// in the https://github.com/prometheus/jmx_exporter/ project.
public class Exporter {
    public static void premain(String agentArgument, Instrumentation instrumentation) throws Exception {
        ...
        new PrometheusExports(CassandraMetricsRegistry.Metrics).register();
